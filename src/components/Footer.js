...
const Footer=()=>{
    return(
        <div style={{backgroundColor:"var(--verydarkViolet)"}} className="w-full lg:flex flex-col items-center pt-8 md:grid md:grid-col-4 md:px-20 ">
            <div className="w-full md:flex flex-row lg:flex flex-row xl:flex flex-row">
                <div className="w-full md:hidden flex justify-center lg:block lg:w-72 md:mt-8">
                ...
                <div className="w-full md:flex flex-row lg:flex flex-row xl:flex flex-row">
                    ...
                    <div className="md:w-1/4 md:mr-6">
                        <h4 className="text-white font-semibold text-center md:text-left text-sm mb-6 mt-8 w-full">Features</h4>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm ">Link Shortening</p>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">Branded Links</p>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">Analytics</p>
                    </div>

                    <div className="md:w-1/4 md:mr-6">
                        <h4 className="text-white font-semibold text-center md:text-left text-sm mb-6 mt-8 w-full">Resources</h4>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">Blog</p>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">Developers</p>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">Support</p>
                    </div>

                    <div className="md:w-1/4 md:mr-6">
                        <h4 className="text-white font-semibold text-center md:text-left text-sm mb-6 mt-8 w-full">Company</h4>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">About</p>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">Our Team</p>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">Careers</p>
                        <p className="text-gray-400 font-semibold  mb-2 text-center md:text-left text-sm">Contact</p>
                    </div>                    

                </div>
                <div className="flex flex-row justify-center xl:flex flex-row justify-center  items-center py-8 w-full md:w-1/4 space-x-6 ">
            ...
            <div className="attribution mx-auto text-white text-xs text-center font-semibold p-4 lg:py-12">
                Challenge by <a style={{color:"var(--cyan"}} href="https://www.frontendmentor.io?ref=challenge" rel="noreferrer" target="_blank">Frontend Mentor</a>. 
                Coded by <a style={{color:"var(--cyan"}} href="#!">Gülay Yolcu</a>.
            </div>
        </div>
