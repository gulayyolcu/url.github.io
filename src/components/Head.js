...
const Head=()=>{
    ...
    const handleClick=()=>{
        ...
        if(show){
          ...
          document.querySelector('.menu').style.flexDirection='flex-col';
        }else{
    ...
    return(
        <div className="mx-10 mt-10 sm:flex sm:flex-col md:flex md:flex-row md:justify-between md:items-center md:mx-16 lg:mx-32">
                <div className="flex flex-row justify-between">
                    ...
                    <div className="btn h-8 w-8 sm:block md:hidden" onClick={handleClick}>
                ...
                <div  className="menu bg-indigo-900 mt-8 py-4 sm:flex flex-col  md:flex md:flex-row md:justify-between md:w-full md:mt-0 md:bg-white md:text-gray-700 text-md rounded rounded-lg">
                    <div className="flex flex-col md:flex-row ">
                        <a href="#!" className="font-semibold p-2 text-center text-white sm:mx-2  lg:px-4 md:mx-2 text-gray-400 rounded md:hover:text-gray-900 md:hover:font-bold transition-colors duration-300">Features</a>
                        <a href="#!" className="font-semibold p-2 text-center text-white sm:mx-2  lg:px-4 md:mx-2 text-gray-400 rounded md:hover:text-gray-900 md:hover:font-bold transition-colors duration-300">Pricing</a>
                        <a href="#!" className="font-semibold p-2 text-center text-white sm:mx-2 lg:px-4 md:mx-2 text-gray-400 rounded md:hover:text-gray-900 md:hover:font-bold transition-colors duration-300">Resources</a>
                    </div>

                    <div className="flex flex-col md:flex md:flex-row">
                        <a href="#!" className="font-semibold borderLink p-2 text-center text-white md:mx-2 text-center md:text-indigo-900 rounded hover:text-indigo-100 hover:text-indigo-700 transition-colors duration-300">Login</a>
                        <a href="#!" style={{backgroundColor:"var(--cyan)"}} className="font-semibold w-48 md:w-28 mx-auto text-white text-center text-md font-bold focus:outline-none hover:opacity-50 py-2 px-6 rounded-full">Sign Up</a>
                    </div>
