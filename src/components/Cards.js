...
const Cards=()=>{
    ...
    return(
       <div style={{backgroundColor:"#f0f1f6"}} className="w-full px-6 mx-auto ">
       

        <div className="flex flex-col sm:flex-row mb-12">
            <div className="max-w-screen-lg mx-auto text-center py-12 mt-4">
                <h2 style={{color:"var(--darkBlue)"}} className="font-bold tracking-tight text-3xl ">
                Advanced Statistics
                </h2>
                <div className="mt-8 flex justify-center">
                    <div className="inline-flex rounded-md">
                        <p className="font-semibold py-2 px-6 text-gray-400">
        ...
        <div className="line22 flex flex-col md:flex-row mb-4 lg:flex lg:flex-row md:mx-10 lg:mx-20">

          <div className="line11"></div>

          <div className="line111 p-2 mb-6">
            <div className="bg-white rounded-md text-center  px-3 lg:text-left lg:flex lg:flex-col lg:items-start ">
              <div className="flex lg:ml-4">
                   <div style={{backgroundColor:"var(--darkViolet)"}} className="flex justify-center items-center rounded-full w-20 h-20 mx-auto -mt-8 ">
              ...
              <h2 className="text-xl font-medium text-gray-700 pt-4 font-bold lg:pl-4">Brand Recognition</h2>
              <p style={{color:"var(--gray)"}} className="font-semibold text-gray-700 block mb-5 pb-8 pt-4 px-4">Boost your brand recognition with each click. Generic links don’t mean a thing. Branded links help instil confidence in your content.</p>
          ...
          <div className="line112 p-2 mb-6 lg:mt-10">
            <div className="bg-white rounded-md text-center px-3 lg:text-left lg:flex lg:flex-col lg:items-start">
              ...
              <h2 className="text-xl font-medium text-gray-700 pt-4 font-bold lg:pl-4">Detailed Records</h2>
              <p style={{color:"var(--gray)"}} className="font-semibold text-gray-700 block mb-5 pb-8 pt-4 px-4">Gain insights into who is clicking your links. Knowing when and where people engage with your content helps inform better decisions.</p>
         ...
         <div className="line113 p-2 mb-6 lg:mt-20">
           <div className="bg-white rounded-md text-center px-3 lg:text-left lg:flex lg:flex-col lg:items-start">
             <div className="flex ml-4">
                   <div style={{backgroundColor:"var(--darkViolet)"}} className="flex justify-center items-center rounded-full w-20 h-20 mx-auto -mt-8">
             ...
             <h2 className="text-xl font-medium text-gray-700 pt-4 font-bold lg:pl-4">Fully Customizable</h2>
             <p style={{color:"var(--gray)"}} className="font-semibold text-gray-700 block mb-5 pb-8 pt-4 px-4">Improve brand awareness and content discoverability through customizable links, supercharging audience engagement.</p>
...
export default Cards;
    ...
    /* <div className="absolute inset-x-1/2 -ml-8 inset-y-56 bg-teal-700 h-96 w-4 z-0"></div> */